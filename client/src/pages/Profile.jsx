...
const Profile = () => {
  ...
  // Ensure values are defined to prevent `.length` errors
  ...
  const displayedPosts = activeTab === "posts" ? posts : bookmarks;
          ...
          <section>
            <div className="flex flex-col gap-5">
              <div className="flex items-center gap-2">
                <span className="font-sm">{userProfile?.username}</span>
              ...
              <div className="flex flex-col gap-1">
                ...
                <span>🤯 Learn code with Akash style</span>
